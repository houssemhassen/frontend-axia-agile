      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link to="/" className="flex items-center text-2xl font-bold text-primary">
              ...
              <span>Axia Agile</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              Empowering teams with modern Agile solutions for effective project management.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Axia Agile. All rights reserved.
            </p>
